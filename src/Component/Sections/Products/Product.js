          ...
          <div className="row justify-content-center" data-aos="fade-up" data-aos-delay="300">
              ...
              <div className="col-md-3 col-sm-6 d-flex ">
                  <div className="serviceBox">
                      <div className="service-icon">
                          <span><img src="http://www.visionrival.com/images/ico.png"></img></span>
                      </div>
              ...
              <div className="col-md-3 col-sm-6 d-flex">
                  <div className="serviceBox purple">
                      <div className="service-icon">
                      <span><img src="http://www.visionrival.com/images/synhealth.svg"></img></span>
                      </div>
              ...
              <div className="col-md-3 col-sm-6 d-flex">
                  <div className="serviceBox">
                      <div className="service-icon">
                          <span><img src="http://www.visionrival.com/images/token.png"></img></span>
                      </div>
              ...
              <div className="col-md-3 col-sm-6 d-flex">
                  <div className="serviceBox purple">
                      <div className="service-icon">
                      <span><img src="http://www.visionrival.com/images/nomp.svg"></img></span>
                      </div>
              ...
              <div className="col-md-3 col-sm-6 d-flex">
                  <div className="serviceBox">
                      <div className="service-icon">
                          <span><img src="http://www.visionrival.com/images/shield.png"></img></span>
                      </div>
