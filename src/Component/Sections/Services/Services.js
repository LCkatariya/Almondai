          ...
          <div className="row">
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div className="icon-box" data-aos="fade-up" data-aos-delay="100">
                    <div className="icon"><i ><img src="http://www.visionrival.com/images/wallet.png" /></i></div>
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div className="icon-box" data-aos="fade-up" data-aos-delay="200">
                    <div className="icon"><i ><img src="http://www.visionrival.com/images/react.png" /></i></div>
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div className="icon-box" data-aos="fade-up" data-aos-delay="300">
                    <div className="icon"><i ><img src="http://www.visionrival.com/images/python.png" /></i></div>
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div className="icon-box" data-aos="fade-up" data-aos-delay="400">
                    <div className="icon"><i ><img src="http://www.visionrival.com/images/dating.png" /></i></div>
